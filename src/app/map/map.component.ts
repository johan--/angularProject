...
export class MapComponent implements OnChanges {
  ...
  constructor(public mapsApiLoader: MapsAPILoader,
              private zone: NgZone,
              private wrapper: GoogleMapsAPIWrapper,public dataService:DataService) {
...
set cityName(value:string){
  ...
  ngOnChanges() {
    // this.dataService.serviceData=this.cityName;
    this.updateOnMap();
    // this.findLocation;
      this.location.marker.draggable = true;
    //   console.log('updating')
    // let full_address:string = this.cityName || ""
    ...
    this.geocoder.geocode({
      ...
      if (status == google.maps.GeocoderStatus.OK) {
        ...
        if (results[0].geometry.location) {
          ...
          this.location.marker.lat = results[0].geometry.location.lat();//make these a service
